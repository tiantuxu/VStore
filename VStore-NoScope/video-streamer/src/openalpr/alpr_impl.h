...
namespace alpr
{
  ...
  class AlprImpl
  {
    ...
    public:
      ...
      std::queue<PlateRegion> recognizeFullDetailsRegion(cv::Mat img, std::vector<cv::Rect> regionsOfInterest);
      AlprFullDetails recognizeFullDetails(cv::Mat img, cv::Mat imgOcr, std::vector<cv::Rect> regionsOfInterest);
      ...
      AlprResults recognize( unsigned char* pixelData, int bytesPerPixel, int imgWidth, int imgHeight, cv::Mat imgOcr, std::vector<AlprRegionOfInterest> regionsOfInterest );
      std::queue<PlateRegion> recognizeregion( unsigned char* pixelData, int bytesPerPixel, int imgWidth, int imgHeight, std::vector<AlprRegionOfInterest> regionsOfInterest );
      AlprResults recognize( cv::Mat img );
      AlprResults recognize( cv::Mat img, std::vector<cv::Rect> regionsOfInterest );
      AlprResults recognize( cv::Mat img, cv:: Mat imgOcr, std::vector<cv::Rect> regionsOfInterest );
      std::queue<PlateRegion> recognizeregion( cv::Mat img, std::vector<cv::Rect> regionsOfInterest );
      AlprResults recognizeresult(cv::Mat colorImg, cv::Mat grayImg, std::queue<PlateRegion> plateQueue);

      AlprFullDetails analyzeSingleCountry(cv::Mat colorImg, cv::Mat grayImg, std::vector<cv::Rect> regionsOfInterest);
      std::queue<PlateRegion> analyzeSingleCountryRegion(cv::Mat colorImg, cv::Mat grayImg, std::vector<cv::Rect> regionsOfInterest);
      AlprFullDetails analyzeSingleCountryResult(cv::Mat colorImg, cv::Mat grayImg, std::queue<PlateRegion> plateQueue);
      AlprFullDetails analyzeSingleCountry(cv::Mat colorImg, cv::Mat grayImg, cv::Mat colorImgOcr, cv::Mat grayImgOcr, std::vector<cv::Rect> regionsOfInterest);
