...
date
echo "dd_thres = 6.75891651652"

#!/bin/bash

# 2018-07-25 17:25:24.198680
...
time /home/luis/noscopeFolder/tensorflow-noscope//bazel-bin/tensorflow/noscope/noscope \
    --diff_thresh=6.75891651652 \
    --distill_thresh_lower=0.0219681341341 \
    --distill_thresh_upper=0.0429377167167 \
    --skip_small_cnn=0 \
    ...
    --yolo_class=2 \
    --confidence_csv=/home/luis/noscopeFolder/data/experiments/jackson-town-square/0.04/test_${START_FRAME}_${END_FRAME}.csv \
    ...
    --use_blocked=0 \
    --ref_image=0 \
    &> /home/luis/noscopeFolder/data/experiments/jackson-town-square/0.04/test_${START_FRAME}_${END_FRAME}.log
