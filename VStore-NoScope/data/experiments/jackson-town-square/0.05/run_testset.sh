...
date
echo "dd_thres = 10.6240800801"

#!/bin/bash

# 2018-07-25 17:21:38.019890
...
time /home/luis/noscopeFolder/tensorflow-noscope//bazel-bin/tensorflow/noscope/noscope \
    --diff_thresh=10.6240800801 \
    --distill_thresh_lower=0.0159768248248 \
    --distill_thresh_upper=0.0159768248248 \
    --skip_small_cnn=0 \
    ...
    --yolo_class=2 \
    --confidence_csv=/home/luis/noscopeFolder/data/experiments/jackson-town-square/0.05/test_${START_FRAME}_${END_FRAME}.csv \
    ...
    --use_blocked=0 \
    --ref_image=0 \
    &> /home/luis/noscopeFolder/data/experiments/jackson-town-square/0.05/test_${START_FRAME}_${END_FRAME}.log
