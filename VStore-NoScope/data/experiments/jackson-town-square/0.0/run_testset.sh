...
date
echo "dd_thres = 1.24290670671"

#!/bin/bash

# 2018-07-25 17:43:17.238339
...
time /home/luis/noscopeFolder/tensorflow-noscope//bazel-bin/tensorflow/noscope/noscope \
    --diff_thresh=1.24290670671 \
    --distill_thresh_lower=0.00998551551552 \
    --distill_thresh_upper=0.996554448448 \
    --skip_small_cnn=0 \
    ...
    --yolo_class=2 \
    --confidence_csv=/home/luis/noscopeFolder/data/experiments/jackson-town-square/0.0/test_${START_FRAME}_${END_FRAME}.csv \
    ...
    --use_blocked=0 \
    --ref_image=0 \
    &> /home/luis/noscopeFolder/data/experiments/jackson-town-square/0.0/test_${START_FRAME}_${END_FRAME}.log
