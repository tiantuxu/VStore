...
date
echo "dd_thres = 5.10604765766"

#!/bin/bash

# 2018-07-23 17:31:51.709196
...
time /home/luis/noscopeFolder/tensorflow-noscope//bazel-bin/tensorflow/noscope/noscope \
    --diff_thresh=5.10604765766 \
    --distill_thresh_lower=0.0820297137137 \
    --distill_thresh_upper=0.0820297137137 \
    --skip_small_cnn=0 \
