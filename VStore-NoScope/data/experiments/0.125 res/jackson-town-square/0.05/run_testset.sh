...
date
echo "dd_thres = 5.47930970971"

#!/bin/bash

# 2018-07-23 17:29:29.169227
...
time /home/luis/noscopeFolder/tensorflow-noscope//bazel-bin/tensorflow/noscope/noscope \
    --diff_thresh=5.47930970971 \
    --distill_thresh_lower=0.0230083343343 \
    --distill_thresh_upper=0.0230083343343 \
    --skip_small_cnn=0 \
