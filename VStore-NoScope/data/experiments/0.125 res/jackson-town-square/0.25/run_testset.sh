...
date
echo "dd_thres = 102.077027027"

#!/bin/bash

# 2018-07-23 17:26:20.492166
...
time /home/luis/noscopeFolder/tensorflow-noscope//bazel-bin/tensorflow/noscope/noscope \
    --diff_thresh=102.077027027 \
    --distill_thresh_lower=0.0190068848849 \
    --distill_thresh_upper=0.0190068848849 \
    --skip_small_cnn=0 \
