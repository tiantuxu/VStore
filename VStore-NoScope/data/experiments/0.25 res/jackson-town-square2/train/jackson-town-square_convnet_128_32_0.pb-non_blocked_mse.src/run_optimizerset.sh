...
time /home/luis/noscopeFolder/tensorflow-noscope//bazel-bin/tensorflow/noscope/noscope \
    ...
    --graph=/home/luis/noscopeFolder/data/cnn-models/jackson-town-square_convnet_128_32_0.pb \
    ...
    --yolo_class=2 \
    --confidence_csv=/home/luis/noscopeFolder/data/experiments/jackson-town-square/train/jackson-town-square_convnet_128_32_0.pb-non_blocked_mse.src/train_${START_FRAME}_${END_FRAME}.csv \
    ...
    --use_blocked=0 \
    --ref_image=0 \
    &> /home/luis/noscopeFolder/data/experiments/jackson-town-square/train/jackson-town-square_convnet_128_32_0.pb-non_blocked_mse.src/train_${START_FRAME}_${END_FRAME}.log
