...
date
echo "dd_thres = 2.03374788789"

#!/bin/bash

# 2018-07-23 16:48:32.742987
...
time /home/luis/noscopeFolder/tensorflow-noscope//bazel-bin/tensorflow/noscope/noscope \
    --diff_thresh=2.03374788789 \
    --distill_thresh_lower=0.00800787187187 \
    --distill_thresh_upper=0.766753731732 \
    --skip_small_cnn=0 \
    ...
    --yolo_class=2 \
    --confidence_csv=/home/luis/noscopeFolder/data/experiments/jackson-town-square/0.02/test_${START_FRAME}_${END_FRAME}.csv \
    ...
    --use_blocked=0 \
    --ref_image=0 \
    &> /home/luis/noscopeFolder/data/experiments/jackson-town-square/0.02/test_${START_FRAME}_${END_FRAME}.log
