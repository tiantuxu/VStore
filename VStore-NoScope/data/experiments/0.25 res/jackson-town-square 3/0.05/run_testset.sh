...
date
echo "dd_thres = 5.73118746747"

#!/bin/bash

# 2018-07-23 16:41:07.673809
...
time /home/luis/noscopeFolder/tensorflow-noscope//bazel-bin/tensorflow/noscope/noscope \
    --diff_thresh=5.73118746747 \
    --distill_thresh_lower=0.00800787187187 \
    --distill_thresh_upper=0.00800787187187 \
    --skip_small_cnn=0 \
