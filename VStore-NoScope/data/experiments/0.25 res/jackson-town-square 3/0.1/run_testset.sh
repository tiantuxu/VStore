...
date
echo "dd_thres = 8.91224954955"

#!/bin/bash

# 2018-07-23 16:39:13.637925
...
time /home/luis/noscopeFolder/tensorflow-noscope//bazel-bin/tensorflow/noscope/noscope \
    --diff_thresh=8.91224954955 \
    --distill_thresh_lower=0.00299627027027 \
    --distill_thresh_upper=0.00299627027027 \
    --skip_small_cnn=0 \
    ...
    --yolo_class=2 \
    --confidence_csv=/home/luis/noscopeFolder/data/experiments/jackson-town-square/0.1/test_${START_FRAME}_${END_FRAME}.csv \
    ...
    --use_blocked=0 \
    --ref_image=0 \
    &> /home/luis/noscopeFolder/data/experiments/jackson-town-square/0.1/test_${START_FRAME}_${END_FRAME}.log
