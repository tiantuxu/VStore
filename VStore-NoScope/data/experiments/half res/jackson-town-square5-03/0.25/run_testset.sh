...
date
echo "dd_thres = 135.720910911"

#!/bin/bash

# 2018-07-20 16:36:17.904566
...
time /home/luis/noscopeFolder/tensorflow-noscope//bazel-bin/tensorflow/noscope/noscope \
    --diff_thresh=135.720910911 \
    --distill_thresh_lower=0.00199894494494 \
    --distill_thresh_upper=0.00199894494494 \
    --skip_small_cnn=0 \
    ...
    --yolo_class=2 \
    --confidence_csv=/home/luis/noscopeFolder/data/experiments/jackson-town-square/0.25/test_${START_FRAME}_${END_FRAME}.csv \
    ...
    --use_blocked=0 \
    --ref_image=0 \
    &> /home/luis/noscopeFolder/data/experiments/jackson-town-square/0.25/test_${START_FRAME}_${END_FRAME}.log
