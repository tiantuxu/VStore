...
date
echo "dd_thres = 7.33954574575"

#!/bin/bash

# 2018-07-20 16:40:03.485690
...
time /home/luis/noscopeFolder/tensorflow-noscope//bazel-bin/tensorflow/noscope/noscope \
    --diff_thresh=7.33954574575 \
    --distill_thresh_lower=0.00499736236236 \
    --distill_thresh_upper=0.00499736236236 \
    --skip_small_cnn=0 \
