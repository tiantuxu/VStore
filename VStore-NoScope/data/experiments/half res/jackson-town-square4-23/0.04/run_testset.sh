...
date
echo "dd_thres = 5.86731367367"

#!/bin/bash

# 2018-07-20 16:01:18.430075
...
time /home/luis/noscopeFolder/tensorflow-noscope//bazel-bin/tensorflow/noscope/noscope \
    --diff_thresh=5.86731367367 \
    --distill_thresh_lower=0.0360300540541 \
    --distill_thresh_upper=0.0360300540541 \
    --skip_small_cnn=0 \
