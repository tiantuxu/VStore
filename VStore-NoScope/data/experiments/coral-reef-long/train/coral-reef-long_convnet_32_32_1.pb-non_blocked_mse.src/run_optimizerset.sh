...
time /home/luis/noscopeFolder/tensorflow-noscope//bazel-bin/tensorflow/noscope/noscope \
    ...
    --graph=/home/luis/noscopeFolder/data/cnn-models/coral-reef-long_convnet_32_32_1.pb \
    ...
    --yolo_class=0 \
    --confidence_csv=/home/luis/noscopeFolder/data/experiments/coral-reef-long/train/coral-reef-long_convnet_32_32_1.pb-non_blocked_mse.src/train_${START_FRAME}_${END_FRAME}.csv \
    ...
    --use_blocked=0 \
    --ref_image=0 \
    &> /home/luis/noscopeFolder/data/experiments/coral-reef-long/train/coral-reef-long_convnet_32_32_1.pb-non_blocked_mse.src/train_${START_FRAME}_${END_FRAME}.log
