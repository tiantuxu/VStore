...
date
echo "dd_thres = 354.215"

#!/bin/bash

# 2018-07-20 14:06:32.378661
...
time /home/luis/noscopeFolder/tensorflow-noscope//bazel-bin/tensorflow/noscope/noscope \
    ...
    --yolo_class=0 \
    --confidence_csv=/home/luis/noscopeFolder/data/experiments/coral-reef-long/0.1/test_${START_FRAME}_${END_FRAME}.csv \
    ...
    --use_blocked=0 \
    --ref_image=0 \
    &> /home/luis/noscopeFolder/data/experiments/coral-reef-long/0.1/test_${START_FRAME}_${END_FRAME}.log
