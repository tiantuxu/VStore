...
date
echo "dd_thres = 473.199"

#!/bin/bash

# 2018-07-20 13:54:59.598764
...
time /home/luis/noscopeFolder/tensorflow-noscope//bazel-bin/tensorflow/noscope/noscope \
    --diff_thresh=473.199 \
    --distill_thresh_lower=0.498498498498 \
    --distill_thresh_upper=0.498498498498 \
    --skip_small_cnn=0 \
    ...
    --yolo_class=0 \
    --confidence_csv=/home/luis/noscopeFolder/data/experiments/coral-reef-long/0.25/test_${START_FRAME}_${END_FRAME}.csv \
    ...
    --use_blocked=0 \
    --ref_image=0 \
    &> /home/luis/noscopeFolder/data/experiments/coral-reef-long/0.25/test_${START_FRAME}_${END_FRAME}.log
